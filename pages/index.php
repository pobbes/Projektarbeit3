                ...
                <div class="span12">
                    <div class="tiles white added-margin">
                        <div class="tiles-body">  
                            <div class="row-fluid">
                                <div class="text-center"><img src="theme/img/logo2.png" data-src="theme/img/logo2.png" width="300"/></div>
                            </div>
                            <div class="row-fluid">
                                <div class="control-group">
                                    <div class="controls text-center">
                                        <form name="search" method="post" action="index.php?page=result" role="form">
                                            <div class="form-group">
                                                <input class="span6 form-control" type="text" name="query" placeholder="Suchen...">
                                            </div>
                                            <br />
                                            <button class="btn btn-large btn-success form-control" type="submit">Suchen</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="span3 ">	
                    <div class="tiles blue added-margin">
                        <div class="tiles-body">
                            ...
                            <div class="heading">
                                <span class="animate-number" data-value="<?php countRows($db); ?>" data-animation-duration="1200">0</span>
                ...
                <div class="span3 ">
                    <div class="tiles green added-margin">
                        <div class="tiles-body">
                            ...
                            <div class="heading">
                                <span class="animate-number" data-value="<?php getNumberOfCountry($db); ?>" data-animation-duration="1000">0</span>	
                            </div>
                            <div class="progress transparent progress-white progress-small no-radius">
                ...
                <div class="span3">
                    <div class="tiles purple added-margin">
                        <div class="tiles-body">
                            ...
                            <div class="tiles-title">
                                Durchschnittl. Hits pro Eintrag
                            </div>	
                            <div class="row-fluid">
                                <div class="heading">
